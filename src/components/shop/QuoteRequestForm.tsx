...
import { WaterButton } from "@/components/site/WaterButton";
...
export function QuoteRequestForm() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 md:py-12">
      <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 font-overpass uppercase mb-2">Get a quote</h1>
      <p className="text-gray-600 mb-8 text-sm md:text-base">
        Review your cart and send your details. We will review your request and contact you with a quotation
        (no online payment).
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10">
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-gray-100 shadow-sm p-6 space-y-4">
          ...
          <WaterButton type="submit" disabled={loading} className="w-full" size="lg">
