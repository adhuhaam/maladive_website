...
export function AboutPage({ settings, resorts }: { settings: Record<string, string>; resorts?: unknown[] }) {
  return (
    <>
{/*  Hero Section  */}
<section className="relative bg-gradient-to-br from-cyan-900 via-cyan-800 to-cyan-700 text-white py-20">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">About Maladive</h1>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-gray-200 rounded-xl p-8 text-center">
                <div className="w-32 h-32 bg-cyan-100 rounded-full flex items-center justify-center mx-auto mb-6">
                    <svg className="w-16 h-16 text-cyan-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                    </svg>
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">10+ Years</h3>
                <p className="text-gray-600">Of excellence in watersports</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Environmental Responsibility</h3>
                <p className="text-gray-600">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Ahmed Hassan</h3>
                <p className="text-cyan-600 font-medium">Founder & CEO</p>
                <p className="text-gray-600 text-sm mt-2">15+ years in watersports industry</p>
            </div>
            ...
            <div className="text-center">
                ...
                <p className="text-cyan-600 font-medium">Operations Director</p>
                <p className="text-gray-600 text-sm mt-2">Expert in adventure tourism</p>
            </div>
            ...
            <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Mohammed Ali</h3>
                <p className="text-cyan-600 font-medium">Safety Manager</p>
                <p className="text-gray-600 text-sm mt-2">Certified safety instructor</p>
            </div>
            ...
            <div className="text-center">
                ...
                <p className="text-cyan-600 font-medium">Customer Experience</p>
                <p className="text-gray-600 text-sm mt-2">Dedicated to guest satisfaction</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
                ...
                <p className="text-cyan-100">Years of Experience</p>
            </div>
            <div>
                <div className="text-4xl font-bold mb-2">50+</div>
                <p className="text-cyan-100">Partner Resorts</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p className="text-cyan-100">Safety Record</p>
            </div>
        </div>
    </div>
</section>
...
<section className="py-20 bg-white">
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready to Join the Adventure?</h2>
        <p className="text-xl text-gray-600 mb-8">
            Experience the thrill of watersports with a company that puts your safety and satisfaction first.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/enquiry" className="bg-cyan-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-cyan-700 transition-colors">
                Start Your Adventure
            </Link>
            <Link href="/contact" className="border-2 border-cyan-600 text-cyan-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-cyan-600 hover:text-white transition-colors">
                Get in Touch
            </Link>
        </div>
    </div>
