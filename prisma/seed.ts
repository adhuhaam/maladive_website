...
async function main() {
  ...
  await prisma.partnerResort.upsert({
    ...
    create: {
      ...
      country: "Maldives",
      description:
        "Luxury resort offering world-class watersports, diving, and excursions in a pristine tropical setting.",
      image: ayadaImage,
      gallery: [ayadaImage],
      rating: "5",
      reviewScore: "9.4",
      ...
      watersportsActivities: ["Jet Ski Adventures", "Kayaking", "Paddleboarding", "Wakeboarding"],
